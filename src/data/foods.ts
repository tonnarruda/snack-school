...
export const FOOD_CATALOG: CatalogEntry[] = [
  ...
  { name: "Iogurte natural", category: "savory", refrigerationRecommended: true, emoji: "🥛" },
  ...
  { name: "Iogurte de morango", category: "sweet", refrigerationRecommended: true, emoji: "🥛", aliases: ["iogurte", "iogurte de frutas"] },
...
export const FOOD_COMBOS: ComboRecipe[] = [
  ...
  { name: "Iogurte com granola", category: "sweet", parts: ["Iogurte natural", "Granola"], emoji: "🥛" },
